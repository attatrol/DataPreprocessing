...
/**
 * Based on {@link com.github.attatrol.preprocessing.distance.nonmetric.similarity.Goodall1Index}.
 * @author atta_troll
 *
 */
public class Goodall1TokenSimilarityIndex extends AbstractCategoricalTokenSimilarityIndex {
     ...
     */
    public Goodall1TokenSimilarityIndex(CategoricalTokenSimilarityIndexData data) {
        super(data);
    }
    ...
    /**
     * Factory for Goodall1 token similarity index.
     * @author atta_troll
     *
     */
    public static class Factory implements GowerTokenSimilarityIndexFactory<Goodall1TokenSimilarityIndex> {

        @Override
        public Goodall1TokenSimilarityIndex getTokenDifferenceCalculator(
                AbstractTokenDataSource<?> dataSource, int index) throws IOException {
            return new Goodall1TokenSimilarityIndex(AbstractCategoricalTokenSimilarityIndex
